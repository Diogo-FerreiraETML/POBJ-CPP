			...
			case 'b':
				...
				if (ValB >= 0 && ValB <=9 )
				{
					for (i=0; i < ValB; i++) { 
						ValB1 = 100 + (10 * i);
						ValB2 = ValB1 / 10000.0;
						std::cout << "TestB: i=" << i << " ValB1 = " << ValB1 << " ValB2 = ";//"TestB: i= %d ValB1 = %d ValB2 = %lf \n", i, ValB1, ValB2;
						cout << left << setfill('0') << setw(7) << ValB2 << std::endl;
					}
				}
				else
				{
